...
$ruby_students = ["Oakley Peavler", "Eric Kanarr", "Tim Minge", "Gary Williams", "Geoff Humphreys", "Oresti Arsi", "Steve Roma", "Sean Shellie"]

$react_students = ["Chad Keller", "Zack Clark",
"Sara Wall", "Michael Prechter", "Dylan Andrew Blake", "Lula Goodwin",
"Matthew McDonald", "Robert Garmhausen", "Ethan Jarrell", "Zoe Cooper", "Francis Walsh", "Matt Morgan", "Michael Ashton", "Brittany Arsi", "Sam Caldwell", "Lorien Olive", "Amelia Royster", "Jason Grigg", "Robert Hutchins"]

$java_students = ["Ethan Philipson", "Bradley Broge"]
